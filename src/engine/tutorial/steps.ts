...
export const INTERACTIVE_TUTORIAL: InteractiveTutorialStep[] = [
  ...
  },
  {
    ...
    chapter: 1,
    chapterTitle: 'Lo esencial',
    title: 'Turno de la Automa',
    body: 'En partida real jugaría la **Automa**. Aquí la saltamos — en solo vs Automa ocurre tras cada uno de tus turnos.',
    wrongHint: '',
    step: { type: 'continue', focus: 'log' },
  },
  ...
  // —— Capítulo 6: Meta ——
  {
    ...
    title: 'Dos eras',
    body: 'La partida tiene **Era Canal** y **Era Ferrocarril**. Termina cada era cuando se agotan mazo y manos. Se puntúan industrias volteadas y enlaces; en Canal se retiran enlaces y nivel 1.',
    wrongHint: '',
    step: { type: 'continue', focus: 'era-turn' },
  },
  {
